...
export function DashboardHeader({ connectionStatus, lastUpdated }: DashboardHeaderProps) {
	return (
		<section className="max-w-xl">
			<h1 className="font-[family-name:var(--font-editorial)] text-[2.4rem] font-light tracking-[-0.05em] text-stone-800 sm:text-[3.2rem]">Am I Okay</h1>
			...
			<div className="mt-6 flex flex-wrap items-center gap-3 text-[11px] text-stone-400 sm:text-xs">
				...
				{lastUpdated ? <span className="tracking-[0.08em] uppercase">Last synced {lastUpdated}</span> : null}
			</div>
		</section>
	);
}
